...
public class DetailActivity  extends AppCompatActivity {
    ...
    @Bind(R.id.ivMediaDetail) ImageView ivMediaDetail;
    @Bind(R.id.tvTimeDetail) TextView tvTimeDetail;
    @Bind(R.id.tvFavContsDetail) TextView tvFavContsDetail;
    @Bind(R.id.tvRetweetsDetail) TextView tvRetweetsDetail;
    @Bind(R.id.ivRetweetDetail) ImageView ivRetweetDetail;
    @Bind(R.id.ivStarDetail) ImageView ivStarDetail;
    @Bind(R.id.ivPostTweetDetail) ImageView ivPostTweetDetail;
